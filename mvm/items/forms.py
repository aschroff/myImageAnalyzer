...
class CreateItemForm(FlaskForm):
    ...
    analysis_keywords = BooleanField(lazy_gettext('analysis of keywords done'))
    analysis_persons = BooleanField(lazy_gettext('analysis of persons done'))
    analysis_celebs = BooleanField(lazy_gettext('analysis of celebs done'))
    analysis_text = BooleanField(lazy_gettext('analysis of text done'))
    analysis_labels = BooleanField(lazy_gettext('analysis of labels done'))
